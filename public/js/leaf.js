(function(d,b,w){
	...
	'.t1{border-color:#f17717;}'+
	'.t2{border-color:#beeb7e;}'+
	'.t3{border-color:#daf439;}'+
	'.t4{border-color:#ff2205;}'+
	'.t5{border-color:#f2f03b;}'+
	'.t6{border-color:#9b990a;}'+
	'.t1::after{border-color:#f17717;}'+
	'.t2::after{border-color:#beeb7e;}'+
	'.t3::after{border-color:#daf439;}'+
	'.t4::after{border-color:#ff2205;}'+
	'.t5::after{border-color:#f2f03b;}'+
	'.t6::after{border-color:#9b990a;}'+
